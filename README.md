...
**Calendar** — See today's events, navigate between days, create events quickly with calendar picker. Tap an event to open Calendar.app.

**Reminders** — View and check off reminders, create new ones instantly.
...
**System** — Clock display, audio device notifications (AirPods), glassmorphism theme option.

## Install

```bash
git clone https://github.com/YOUR_USERNAME/Notchy.git
cd Notchy
bash build.sh
open Notchy.app
```
